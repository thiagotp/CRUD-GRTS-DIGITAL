          ...
          <div class="card">
            ...
            <label for="">DADOS DA EMPRESA<br></label>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input size="50" class="form-control" name="nome_empresa" id="nome_empresa" onkeypress='return filtroTeclasLetras(event)' type="text" placeholder="Nome da Empresa" required="" value="<?php echo !empty($nome_empresa)?$nome_empresa: '';?>">
