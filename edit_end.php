...
$resulta = mysqli_query($connect, "SELECT * FROM endereco WHERE id=$id");
        ...
        <div clas="span10 offset1">
          <div class="card">
            <div class="card-header">
                <h3 class="well"> Editar Endereço </h3>
            </div>
            <div class="card-body">
            <form class="form-horizontal" action="edit_end_sql.php" method="post">
